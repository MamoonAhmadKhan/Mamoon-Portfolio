    ...
    <section id="about" className="py-10 px-48 max-[1100px]:px-20 font-sans">
      <div className="flex max-[800px]:flex-col-reverse items-center justify-between">
        ...
        <div className="text-white text-left max-[800px]:text-center max-[800px]:w-full mt-8 w-1/2">
          <h2 className="text-3xl max-[425px]:text-lg max-[800px]:text-2xl max-[1000px]:text-2xl min-[2300px]:text-6xl font-bold mb-2 leading-tight">
            Hi, I am
          </h2>
          ...
          {/* about me section */}
          <p className="text-base max-[800px]:text-xs min-[2300px]:text-2xl max-[1000px]:text-sm text-gray-300 mb-6 mt-8 leading-relaxed">
          ...
          <p className="text-amber-200 max-[530px]:hidden font-medium font-mono">khanmamoon887@gmail.com | 8744920999</p>
          <p className="text-amber-200 min-[530px]:hidden font-normal text-sm font-mono">khanmamoon887@gmail.com</p>
          <p className="text-amber-200 min-[530px]:hidden font-normal text-sm font-mono">8744920999</p>
          ...
          <a
            ...
            className="cursor-pointer inline-block text-white py-3 px-8 max-[425px]:py-1 max-[425px]:px-5 max-[800px]:py-2 max-[800px]:px-7 min-[2300px]:py-4 min-[2300px]:px-9 rounded-full mt-8 max-[425px]:text-sm max-[425px]:font-medium text-lg min-[2300px]:text-xl font-bold transition duration-300 transform hover:scale-105"
            style={{
        ...
        <div className="flex justify-center w-1/2 max-[500px]:w-full">
          <Tilt
            className="w-2/3 min-[2300px]:w-1/2 border-4 border-purple-700 rounded-full"
            tiltMaxAngleX={20}
            tiltMaxAngleY={20}
            perspective={1000}
            scale={1.05}
